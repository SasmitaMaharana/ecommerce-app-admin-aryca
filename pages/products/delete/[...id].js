      ...
      <div class="mx-auto w-full overflow-hidden rounded-lg bg-gray-100 shadow-xl sm:max-w-sm">
        <div class="relative p-5">
          <div class="text-center">
            ...
            <div>
              <h3 class="text-lg font-medium text-secondary-900 text-">Delete <span className="text-green-600">{productInfo?.title}</span></h3>
